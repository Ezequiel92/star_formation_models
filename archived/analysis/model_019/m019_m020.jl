...
using DifferentialEquations, PlutoUI, TikzPictures, Unitful, UnitfulAstro, SpecialFunctions, QuadGK, CairoMakie, Symbolics, LinearAlgebra
...
begin
	model_019 = include_module("../models/model_019/description_m019.jl")
	model_020 = include_module("../models/model_020/description_m020.jl")
end;
...
let
	...
	# Integration
	sol_019 = model_019.integrate_model(ic, tspan, parameters)
	sol_020 = model_020.integrate_model(ic, tspan, parameters)
	...
	sf_019 = sol_019(time)[5, :]
	sf_020 = sol_020(time)[5, :]
	...
	lines!(ax, time, sf_019, linewidth = 3, label = "Model 19")
	lines!(ax, time, sf_020, linewidth = 3, label = "Model 20")
...
# ╔═╡ 9fd4d5ee-c867-4e99-aae9-8db23411d7e5
let
...
# ╔═╡ bc0df822-376b-496e-9911-335b0eeeaecf
md"# Molecular fraction"

# ╔═╡ 025643fd-c366-494d-bd77-150d0c2f81aa
md"# Low density"
...
let
	...
	mf_019 = sol_019(time)[3, :]
	mf_020 = sol_020(time)[3, :]
	...
	lines!(ax, time, mf_019, linewidth = 3, label = "Model 19")
	lines!(ax, time, mf_020, linewidth = 3, label = "Model 20")
...
# ╔═╡ 510b97e4-db1b-431b-ad46-d9d1e31a2baa
let
	...
	af_019 = sol_019(time)[2, :]
	af_020 = sol_020(time)[2, :]
	...
	lines!(ax, time, af_019, linewidth = 3, label = "Model 19")
	lines!(ax, time, af_020, linewidth = 3, label = "Model 20")
...
# ╔═╡ 05398c55-469c-42c9-b70a-e6a60167dc73
md"# High density"

# ╔═╡ 5085c940-ec03-421e-83b9-2ea13f871cb1
let
...
# ╔═╡ 67afa349-36c7-4ed0-bc20-89a21817829b
let

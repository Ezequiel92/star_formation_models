...
# ╔═╡ 8f3dbcb2-bbb6-4fbf-b3bd-9de9d7585ac5
TableOfContents(title="🌌 Analysis of model 019 - MF", depth=4)

# ╔═╡ 1fe3f3d7-a213-43f2-a398-145a2e0516e7
...
# ╔═╡ c6b97052-7e78-475b-b09c-f988fcd6ee02
md"# Load the model"

# ╔═╡ b38b6c5e-3f83-4bb1-a394-fa79fb876f33
...
# ╔═╡ 5bf3e91e-2406-4831-b401-8b0764a85cc4
...
function molecular_fraction(
	...
	if ρ_PDF === nothing
		...
		inter_sol = sol(times)
		molecular_fraction = replace(x -> x <= 0 ? NaN : x, inter_sol[3, :])
		...
		molecular_fraction = zeros(Float64, length(times))
	...
	return times, molecular_fraction
...
let
	time, m019 = molecular_fraction(nothing, param)
	time .*= 1000 # Gyr |> Myr
	_, Krumholz2005 = molecular_fraction(pKrumholz2005, param)
	_, Burkhart2018 = molecular_fraction(pBurkhart2018, param)	
...
let
	...
	Krumholz2005 = [molecular_fraction(
		pKrumholz2005, 
		Params(
			b = 0.5,
			Ms = 10.0,
	...
	Burkhart2018 = [molecular_fraction(
		pBurkhart2018, 
		Params(
			b = 0.5,
			Ms = 10.0,

/***************************************************************************************
* Numerical solution for the modified basic model with coupled metallicity.
* (modified to have the same constants as the Ascasibar model)
****************************************************************************************/

const char name[] = "Modified basic model with coupled metallicity";
...
struct jacobi_var
{
	...
	void operator()(const State &y, Matrix &J, const Double &t, State &dfdt)
	{
		...
		J(1,0) = 8.158;
		J(1,1) = -0.283582089552239*(0.0000134 + y[4]);
		J(1,2) = -220.9076923076923;
		J(1,3) = 0;
		J(1,4) = -0.283582089552239*y[1];

		J(2,0) = 0;
		J(2,1) = 0.283582089552239*(0.0000134 + y[4]);
		J(2,2) = -146.89615384615382;
		J(2,3) = 0;
		J(2,4) = 0.283582089552239*y[1];

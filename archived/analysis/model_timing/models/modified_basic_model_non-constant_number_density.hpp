/***************************************************************************************
* Numerical solution for the modified basic model with non-constant number density.
* (modified to have the same constants as the Ascasibar model)
****************************************************************************************/

const char name[] = "Modified basic model with non-constant number density";
...
struct jacobi_const
{
	...
	void operator()(const State &y, Matrix &J, const Double &t, State &dfdt)
	{
		...
		J(0, 0) = -0.002970561010184388;
		J(0, 1) = 0;
		J(0, 2) = 367.41923076923075;
		J(0, 3) = -0.0017823366061106329;
		J(0, 4) = 0;

		J(1, 0) = 0.002970561010184388;
		J(1, 1) = -6.957951453129975e-8;
		J(1, 2) = -220.9076923076923;
		J(1, 3) = 0.0017823226902077265;
		J(1, 4) = 0;

		J(2, 0) = 0;
		J(2, 1) = 6.957951453129975e-8;
		J(2, 2) = -146.89615384615382;
		J(2, 3) = 1.3915902906259951e-8;
		J(2, 4) = 0;
...
struct jacobi_var
{
	...
	void operator()(const State &y, Matrix &J, const Double &t, State &dfdt)
	{
		...
		J(0, 0) = -0.002970561010184388 * (1. + y[3]);
		J(0, 1) = 0;
		J(0, 2) = 367.41923076923075;
		J(0, 3) = -0.002970561010184388 * y[0];
		J(0, 4) = 0;

		J(1, 0) = 0.002970561010184388 * (1. + y[3]);
		J(1, 1) = -6.957951453129975e-8 * (1. + y[3]);
		J(1, 2) = -220.9076923076923;
		J(1, 3) = -6.957951453129975e-8 * y[1] + 0.002970561010184388 * y[0];
		J(1, 4) = 0;

		J(2, 0) = 0;
		J(2, 1) = 6.957951453129975e-8 * (1. + y[3]);
		J(2, 2) = -146.89615384615382;
		J(2, 3) = 6.957951453129975e-8 * y[1];
		J(2, 4) = 0;

...
TableOfContents(title="🌌 Model 017", depth=4)
...
Markdown.MD(
	Markdown.Admonition(
		"note", 
		"Names", 
		[md"Model 017", md"New full model", md"Model D"]
	)
)
...
plot(
	...
	safe_i, 
	xaxis = ("t / Gyr", :log), 
	yaxis = (L"ionized gas density / $\textrm{M}_\odot\,\textrm{pc}^{-3}$", :log),
)
...
plot(
	...
	safe_m, 
	xaxis = ("t / Gyr", :log), 
	yaxis = L"molecular gas density / $\textrm{M}_\odot\,\textrm{pc}^{-3}$",
)
...
plot(
	...
	safe_s, 
	xaxis = ("t / Gyr", :log),
	yaxis = (L"stellar density / $\textrm{M}_\odot\,\textrm{pc}^{-3}$", :log),
)

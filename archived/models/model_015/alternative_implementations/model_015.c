...
* Model 015
*
* Alternative names: 'Model F'
*******************************************************************************************/

static const char NAME[] = "Model 015";     // Model name
...
static int ode_system(double t, const double y[], double f[], void *params)
{
    ...
    double psi = (y[2] + alpha * y[1]) / tau_S;

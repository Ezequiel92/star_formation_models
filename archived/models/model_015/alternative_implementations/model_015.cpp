...
const char NAME[] = "Model 015"; // Model name
...
struct jacobian
{
    ...
    void operator()(const State &y, Matrix &J, const double &t, State &dfdt)
    {
        ...
        J(1, 0) = 8158. * n;
        J(1, 1) = -1546.353846 - 283.5820896 * n * (0.0000134 + Z);
        J(1, 2) = -220.9076923;
        J(1, 3) = 0;
        J(1, 4) = 0;

        J(2, 0) = 0;
        J(2, 1) = -1028.273077 + 283.5820896 * n * (0.0000134 + Z);
        J(2, 2) = -146.8961538;
        J(2, 3) = 0;
        J(2, 4) = 0;

        J(3, 0) = 0;
        J(3, 1) = 2.692307692 * (0.0162 - 1. * Z);

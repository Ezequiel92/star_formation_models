...
TableOfContents(title="🌌 Model 005", depth=4)
...
Markdown.MD(
	Markdown.Admonition(
		"note", 
		"Names", 
		[md"Model 005", md"Modified basic model with a non-constant number density"]
	)
)
...
begin
	...
	const NUMPAR = 2    # Number of parameters
end;
...
plot(
	...
	safe_m, 
	xaxis = ("t / Gyr", :log), 
	yaxis = ("molecular gas fraction", :log),
)

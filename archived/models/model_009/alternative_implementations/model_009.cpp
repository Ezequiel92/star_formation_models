...
const char NAME[] = "Model 009"; // Model name
...
struct jacobian
{
    ...
    void operator()(const State &y, Matrix &J, const double &t, State &dfdt)
    {
        ...
        J(3, 0) = ((0.3 * y[1] + y[2]) * y[3]) / pow(y[1] + y[0] + y[2], 2);
        J(3, 1) = ((0.3 * y[1] + y[2]) * y[3]) / pow(y[1] + y[0] + y[2], 2) - (0.2 * y[3]) / (y[1] + y[0] + y[2]) + 0.1 * (0.0102 - (1. * y[3]) / (y[1] + y[0] + y[2]));
        J(3, 2) = ((0.3 * y[1] + y[2]) * y[3]) / pow(y[1] + y[0] + y[2], 2) - (0.6666666667 * y[3]) / (y[1] + y[0] + y[2]) + 0.3333333333 * (0.0102 - (1. * y[3]) / (y[1] + y[0] + y[2]));
        J(3, 3) = (-1. * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]);
        J(3, 4) = 0;

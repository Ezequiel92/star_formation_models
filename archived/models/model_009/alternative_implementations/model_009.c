...
static const char NAME[] = "Model 009"; // Model name
...
static int ode_system(double t, const double y[], double f[], void *params)
{
    ...
    /* ODE system */
    f[0] = Ii - Oi - recombination + (eta_ion + R) * psi;
    f[1] = -Oa - cloud_formation + recombination + (eta_diss - eta_ion - alpha * y[1] / star_elem) * psi;
    f[2] = -Om + cloud_formation - (eta_diss + y[2] / star_elem) * psi;
    f[3] = -Oz + (Zsn * R - Z) * psi;
    f[4] = (1 - R) * psi;
...
int jacobian(double t, const double y[], double *dfdy, double dfdt[], void *params)
{
    ...
    gsl_matrix_set(m, 2, 0, (0.6666666667 * y[2] * (0.3 * y[1] + y[2])) / pow(y[1] + y[0] + y[2], 2) - (208.855472 * y[1] * (y[1] + y[0] + y[2] + y[4]) * y[3]) / ((y[1] + y[0] + y[2]) * (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]))) + (208.855472 * y[1] * (y[1] + y[0] + y[2]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])) + (34809.24534 * y[1] * (0.3 * y[1] + y[2]) * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / ((y[1] + y[0] + y[2]) * pow(1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]), 2)) + (208.855472 * y[1] * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])));
    gsl_matrix_set(m, 2, 1, (0.1 * y[2]) / (0.3 * y[1] + y[2]) + (0.6666666667 * y[2] * (0.3 * y[1] + y[2])) / pow(y[1] + y[0] + y[2], 2) - (0.2 * y[2]) / (y[1] + y[0] + y[2]) + 0.1 * (-75. * (1. - 1. / exp(6666.666666667 * y[2])) - (1. * y[2]) / (0.3 * y[1] + y[2])) - (208.855472 * y[1] * (y[1] + y[0] + y[2] + y[4]) * y[3]) / ((y[1] + y[0] + y[2]) * (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]))) + (208.855472 * y[1] * (y[1] + y[0] + y[2]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])) - (208.855472 * y[1] * (y[1] + y[0] + y[2]) * ((-166.6666667 * (0.3 * y[1] + y[2])) / pow(y[1] + y[0] + y[2], 2) + 50. / (y[1] + y[0] + y[2])) * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / pow(1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]), 2) + (208.855472 * y[1] * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])) + (208.855472 * (y[1] + y[0] + y[2]) * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])));
    gsl_matrix_set(m, 2, 2, (0.6666666667 * y[2] * (0.3 * y[1] + y[2])) / pow(y[1] + y[0] + y[2], 2) - (0.6666666667 * y[2]) / (y[1] + y[0] + y[2]) - (0.6666666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]) - 0.3333333333 * (0.3 * y[1] + y[2]) * (500000. / exp(6666.666666667 * y[2]) - (1. * y[2]) / pow(0.3 * y[1] + y[2], 2) + 1 / (0.3 * y[1] + y[2])) + 0.3333333333 * (-75. * (1. - 1. / exp(6666.666666667 * y[2])) - (1. * y[2]) / (0.3 * y[1] + y[2])) - (208.855472 * y[1] * (y[1] + y[0] + y[2] + y[4]) * y[3]) / ((y[1] + y[0] + y[2]) * (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]))) + (208.855472 * y[1] * (y[1] + y[0] + y[2]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])) - (208.855472 * y[1] * (y[1] + y[0] + y[2]) * ((-166.6666667 * (0.3 * y[1] + y[2])) / pow(y[1] + y[0] + y[2], 2) + 166.6666667 / (y[1] + y[0] + y[2])) * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / pow(1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]), 2) + (208.855472 * y[1] * (y[1] + y[0] + y[2] + y[4]) * (6.e-6 + y[3] / (y[1] + y[0] + y[2]))) / (1. + (166.6666667 * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2])));
    ...
    gsl_matrix_set(m, 3, 0, ((0.3 * y[1] + y[2]) * y[3]) / pow(y[1] + y[0] + y[2], 2));
    gsl_matrix_set(m, 3, 1, ((0.3 * y[1] + y[2]) * y[3]) / pow(y[1] + y[0] + y[2], 2) - (0.2 * y[3]) / (y[1] + y[0] + y[2]) + 0.1 * (0.0102 - (1. * y[3]) / (y[1] + y[0] + y[2])));
    gsl_matrix_set(m, 3, 2, ((0.3 * y[1] + y[2]) * y[3]) / pow(y[1] + y[0] + y[2], 2) - (0.6666666667 * y[3]) / (y[1] + y[0] + y[2]) + 0.3333333333 * (0.0102 - (1. * y[3]) / (y[1] + y[0] + y[2])));
    gsl_matrix_set(m, 3, 3, (-1. * (0.3 * y[1] + y[2])) / (y[1] + y[0] + y[2]));

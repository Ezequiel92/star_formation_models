...
TableOfContents(title="🌌 Model 009", depth=4)
...
Markdown.MD(
	Markdown.Admonition(
		"note", 
		"Names", 
		[md"Model 009", md"Full model (constant $\tau_S$ with infall and outflow)"]
	)
)
...
plot(
	...
	xaxis = ("t / Gyr", :log), 
	yaxis = (
		L"ionized gas density / $\textrm{M}_\odot\,\textrm{pc}^{-2}$", 
		:log,
	),
)
...
plot(
	...
	xaxis = ("t / Gyr", :log), 
	yaxis = (
		L"atomic gas density / $\textrm{M}_\odot\,\textrm{pc}^{-2}$", 
		:log,
	),
)
...
plot(
	...
	xaxis = ("t / Gyr", :log), 
	yaxis = (
		L"molecular gas density / $\textrm{M}_\odot\,\textrm{pc}^{-2}$", 
		:log,
	),
)
...
plot(
	...
	safe_z, 
	xaxis = ("t / Gyr", :log), 
	yaxis = (L"metal density / $\textrm{M}_\odot\,\textrm{pc}^{-2}$", :log),
)

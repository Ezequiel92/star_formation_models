...
using OrdinaryDiffEq, Plots, Symbolics, LinearAlgebra, PlutoUI, PGFPlotsX

# ╔═╡ a4bc5fbc-a038-4446-95b7-efd0cc5c06ae
TableOfContents(title="🌌 Model 014", depth=4)
...
Markdown.MD(
	Markdown.Admonition(
		"note", 
		"Names", 
		[md"Model 014", md"Simplified model"]
	)
)
...
function integrate_model(y₀, tspan, params)
    ...
    return solve(prob, ABDF2(), reltol = 1e-8, abstol = 1e-8)
end;

...
const char NAME[] = "Model 014"; // Model name
...
int main()
{
    ...
    printf("Stellar fraction after %gGyr (rosenbrock4): %.3g Mₒpc^(-2)\n", t_end, Y0[4]);

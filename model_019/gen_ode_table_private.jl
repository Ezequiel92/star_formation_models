...
begin
	...
	fun_zf(idx) = log_idx_to_val(idx[2], N[2], z0[1], z0[2])
	fun_rh(idx) = log_idx_to_val(idx[3], N[3], ρ0[1], ρ0[2])
	fun_it(idx) = lin_idx_to_val(idx[4], N[4], it[1], it[2])
	...
	inv_fun_zf(fi) = log_val_to_idx(fi[2], N[2], z0[1], z0[2])
	inv_fun_rh(fi) = log_val_to_idx(fi[3], N[3], ρ0[1], ρ0[2])
	inv_fun_it(fi) = lin_val_to_idx(fi[4], N[4], it[1], it[2])

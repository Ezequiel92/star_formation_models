...
# ╔═╡ fe60f4e0-f84d-11ec-1e59-e95f03be5d11
...
# ╔═╡ 575ff6dd-adf8-4d27-a8be-e744231fd50b
...
# ╔═╡ d7057208-4648-412d-94f3-b2e7b85f20b3
md"""# Jacobian"""

# ╔═╡ b23928eb-4ca7-46ee-8241-1c044452bdac
md"## Load the model"

# ╔═╡ 270ae7ac-d600-4763-8e35-2950cf66d0ba
model = include_module("./model_019.jl");

# ╔═╡ e999d5a1-c881-431a-9351-54e442b9c0a8
begin
NUMEQU = model.NUMEQU
y, params, t = model.y, model.params, model.t
end;

# ╔═╡ 8bb95901-ff49-4016-b8f3-d073d11de6a8
md"## Write Jacobian into file"
  ...
  gsl_matrix *m            = &dfdy_mat.matrix;\n\n"
	...
	for i in 1:NUMEQU
		for j in 1:NUMEQU
			...
			index = (i - 1) * NUMEQU + j
			dfdt[index] = model.jac_num_arr[i, j](y, params, t)

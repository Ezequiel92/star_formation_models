...
# ╔═╡ 8c7429e0-aecb-11ec-184a-bf25ce086d90
...
# ╔═╡ 4add2797-5233-4aea-b429-09cf5487ccb1
md"# Load the model"

# ╔═╡ a4e01426-aa81-4412-b9ce-0872150c64aa
md"# Constants"

# ╔═╡ d4af0951-58b2-4245-8be0-0340bd857588
begin
	const IMF = "Salpeter1955A"
	const NUMEQU = 5
end;

# ╔═╡ d8dcdc54-c135-4634-8f99-c14ccc075c12
md"## Density in internal units"

# ╔═╡ 7bf55db4-f719-4b56-ba29-60f9b896b386
begin
	n₀ = 0.9u"cm^-3"
	...
	PARSEC = 3.085678e18
	rho_cgs = 6.77e-22
	UnitDensity_in_cgs = 6.77e-22
    HubbleParam = 1.0
	a3inv = 1.0
    UnitTime_in_s = 3.085678e16
...
# ╔═╡ ff965918-258b-4a46-af56-7fd473cc345c
md"## Integration time in internal units"

# ╔═╡ 7d15f48b-019d-4ccd-b135-6042eb5ea813
begin
...
# ╔═╡ e098a397-fa4d-480a-83d9-e5845334f4bd
md"# Interpolation function (ηion)"

# ╔═╡ cc1b2759-9bf3-48ea-a569-c1e5f139a831
md"# Interpolation function (ηdiss)"

# ╔═╡ 061333c3-2ffc-4b6d-b460-977548b7f263
md"# Reference values for the ODE system"

# ╔═╡ 6ff8aad4-bfd1-4c47-a67d-5ed67412c694
md"# Reference values for the Jacobian"

# ╔═╡ 13b5b3ab-efc9-45b6-9454-b6e0b4be665d
md"# Reference values for the C function `compute_fractions`"

# ╔═╡ 05f42134-1d1b-43f4-acda-b0d6b7410625
md"# Reference value for the C function `compute_star_fraction`"

# ╔═╡ 6dcbd814-0973-48b0-8e7e-d5c0f21512c2
...
# ╔═╡ 51edc5bc-5e52-4305-a50c-8dc7be26b461
model = include_module("./description_m019.jl");

# ╔═╡ 0bca85f0-2cc6-42ec-bae5-e13897333371
model.itp_ion[IMF](0.0)

# ╔═╡ fb9f5861-86bc-47cb-934a-3cc2b62c895a
model.itp_ion[IMF](0.0069)

# ╔═╡ 4c45372d-49c7-4eef-ba9d-3c5ee3ad1e12
model.itp_ion[IMF](0.004269)

# ╔═╡ cecd9245-56b1-4c40-bd9e-1d652af26728
model.itp_ion[IMF](0.69)

# ╔═╡ 3f9fbb5d-3823-47e5-accf-55a250a8efbf
model.itp_diss[IMF](0.0)

# ╔═╡ ecbf5486-be67-433b-9810-af61af1c8e26
model.itp_diss[IMF](0.0069)

# ╔═╡ ef196c79-e457-49db-9c2b-9d7691274600
model.itp_diss[IMF](0.004269)

# ╔═╡ b64da67d-0720-4194-aea3-acd4f7b75229
model.itp_diss[IMF](0.69)

# ╔═╡ d979f2b1-832b-482c-9a96-9b5737912d56
let
	dydt = Array{Float64}(undef, NUMEQU)
	...
	model.system!(dydt, ic, parameters, 0.0)

	dydt
end

# ╔═╡ 2ced5608-cbfd-4242-a751-176830e7441e
let
	dydt = Vector{Float64}(undef, NUMEQU*NUMEQU)
...
# ╔═╡ 2278bb1b-c05d-41f3-8d82-bb72a8655bce
let
	# Initial conditions
	n₀ = 0.9u"cm^-3"
	i₀ = 0.3
...
# ╔═╡ fae132f3-ff2f-472e-b222-5f0846de8cc4
let
	# Initial conditions
	n₀ = 0.9u"cm^-3"
	i₀ = 0.3
